...
int main()
{
    ...
    playerDrawCard->Add<SpriteComponent>(std::string("Draw Card"), manager.textureManager.Load("../cards/backface.png"), Color(WHITE));
    ...
    enemyDraw->Add<SpriteComponent>(std::string("Enemy Draw"), Texture2D(), Color(MAROON));
    ...
    enemyDiscard->Add<SpriteComponent>(std::string("Enemy Discard"), Texture2D(), Color(DARKGRAY));
    ...
    enemyDrawCard->Add<SpriteComponent>(std::string("Enemy Draw Card"), manager.textureManager.Load("../cards/backface.png"), Color(WHITE));
